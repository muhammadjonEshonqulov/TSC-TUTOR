...
import uz.jbnuu.tsc.tutor.ui.MainActivity
...
//        val role = prefs.get(prefs.role, "")
        ...
        val pendingIntent = NavDeepLinkBuilder(baseContext)
            ...
            .setDestination(R.id.tutorMainFragment)  // if (role == prefs.admin) R.id.allNotificationsFragment else R.id.allNotificationsFragment
            .setArguments(bundle)
            .createPendingIntent()
