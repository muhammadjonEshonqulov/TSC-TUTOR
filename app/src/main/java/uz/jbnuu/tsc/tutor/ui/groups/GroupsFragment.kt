...
import uz.jbnuu.tsc.tutor.adapters.GroupAdapter
import uz.jbnuu.tsc.tutor.base.BaseFragment
import uz.jbnuu.tsc.tutor.base.ProgressDialog
import uz.jbnuu.tsc.tutor.databinding.GroupFragmentBinding
import uz.jbnuu.tsc.tutor.model.group.GroupData
...
class GroupsFragment : BaseFragment<GroupFragmentBinding>(GroupFragmentBinding::inflate), View.OnClickListener, GroupAdapter.OnItemClickListener {
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        binding.listGroup.adapter = null
    }
...
//                        findNavController().navigateSafe(R.id.action_groupsFragment_to_loginFragment)
    ...
    private fun loginTyuter() {
        vm.loginTyuter(LoginTyuterBody(prefs.get(prefs.login, ""), prefs.get(prefs.password, "")))
